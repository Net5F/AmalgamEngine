...
## Shared Libraries
There's currently a lot of shared libs committed through git-lfs. The SDL2-related libs will be taken care of by submoduling the mirrors (https://github.com/SDL-mirror) and switching to static linking (not an ethical issue because we're AGPL-licensed). The OS-specific libs will be handled with some TBD method.
