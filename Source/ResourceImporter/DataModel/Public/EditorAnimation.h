...
struct EditorAnimation {
    ...
    /** If non-null, this is the ID of this animation's model-space bounding
       box. Defines the animation's 3D volume. Used in hit testing for user
       mouse events, and for collision checks ( if collisionEnabled). */
