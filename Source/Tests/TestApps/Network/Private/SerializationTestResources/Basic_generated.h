...
struct Entity FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  float velZ() const {
    return GetField<float>(VT_VELZ, 0.0f);
  }
...
struct EntityBuilder {
  ...
  void add_z(float z) {
    fbb_.AddElement<float>(Entity::VT_Z, z, 0.0f);
  }
