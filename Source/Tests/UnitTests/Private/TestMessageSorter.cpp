...
TEST_CASE("TestMessageSorter")
{
    ...
    //        messageSorter.startReceive(0); REQUIRE(!(queue.empty()));
    //
    ...
    //        // Try to receive.
    //        std::queue<BinaryBufferPtr>& queue =
    //        messageSorter.startReceive(0); REQUIRE(queue.size() == 10);
    //
    //        Uint8 counter = 0;
    //        while (!queue.empty()) {
    ...
    //                std::make_unique<std::vector<Uint8>>(
    //                                             std::vector<Uint8>{i, i,
    //                                             i}));
    //            }
    //        }
    //
    ...
    //                BinaryBufferPtr message = std::move(queue->front());
    //                REQUIRE(*message
    //                        == std::vector<Uint8>({counter, counter,
    //                        counter}));
    //
    //                // Prep for the next message.
    //                queue->pop();
    ...
    //        for (unsigned int i = 0; i < Server::MessageSorter::BUFFER_SIZE;
    //        ++i) {
    ...
    //        messageSorter.push(
    //            Server::MessageSorter::BUFFER_SIZE,
    //            std::make_unique<std::vector<Uint8>>(std::vector<Uint8>{1, 2,
    //            3}));
    //
    //        // Try to receive.
    //        std::queue<BinaryBufferPtr>& queue
    ...
    //        // Try to receive.
    //        std::queue<BinaryBufferPtr>& queue =
    //        messageSorter.startReceive(7); REQUIRE(!(queue.empty()));
    //
    //        BinaryBufferPtr message = std::move(queue.front());
    //        REQUIRE(*message == std::vector<Uint8>({1, 2, 3}));
    //
    ...
    //
    //        Sint64 result2 = messageSorter.push(
    //            1000 - 1, std::make_unique<BinaryBuffer>(BinaryBuffer{1, 2,
    //            3}));
    //
    //        REQUIRE(result1 == 0);
    //        REQUIRE(result2 == -1);
    ...
    //    {
    //        // Push a message (we're going to leave it as a marker for
    //        wrapping.) messageSorter.push(0,
    //        std::make_unique<std::vector<Uint8>>(
    //                                  std::vector<Uint8>{1, 2, 3}));
    //
    ...
    //        messageSorter.endReceive();
    //
    //        // Try to receive, since we should have wrapped back to the
    //        original
    //        // message.
    //        queue
    //            =
